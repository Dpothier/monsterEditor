...
require('styles/monsterEditor/ScrollableDropdownMenu.css');
...
var ScrollableDropdownMenu = function (_React$Component) {
  (0, _inherits3['default'])(DropdownMenu, _React$Component);

  function ScrollableDropdownMenu(props) {
...
exports['default'] = (0, _bootstrapUtils.bsClass)('scrollable-dropdown-menu', DropdownMenu);
